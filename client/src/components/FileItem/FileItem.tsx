    ...
    return (
        <div onClick={() => handleFileClick(fileItem.id)}
            ...
            <div className="file-item__options">
                ...
                <a onClick={e => e.stopPropagation()} href={`/cdn/${fileItem.id}`} download={fileItem.id} className="file-item__button file-item__button--download">
                ...
                <button onClick={e => handleDelete(e, fileItem.id)} className="file-item__button file-item__button--delete">
                    <svg xmlns="http://www.w3.org/2000/svg" height="24" width="24">
