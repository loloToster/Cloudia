    ...
    <div className="pre-pdf">
      <div className="pre-pdf__inner" ref={observedDiv}>
        <div className="pre-pdf__inner__inner">
          <Document file={`/cdn/${item.id}`} onLoadSuccess={onDocumentLoadSuccess}>
            <Page
              pageNumber={curPage}
      ...
      <div className="pre-pdf__pages">
        <button onClick={() => handlePageChange(-1)} className="left">
          <svg xmlns="http://www.w3.org/2000/svg" height="16" viewBox="0 -960 960 960" width="16"><path d="m321-80-71-71 329-329-329-329 71-71 400 400L321-80Z"></path></svg>
        </button>
